    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoardAiSettings", x => x.BoardId);
                    table.ForeignKey(
                        name: "FK_BoardAiSettings_Boards_BoardId",
                        column: x => x.BoardId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReminderTime = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CardLabel", x => new { x.CardId, x.LabelsId });
                    table.ForeignKey(
